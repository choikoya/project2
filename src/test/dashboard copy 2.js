...
import TimeVehicleChart from '../dashboard/timeVehicleChart';
import VehicleTypeDoughnut from '../dashboard/vehicleTypeDoughnut';
import Notice from '../notice/notice';
import Graph from '../dashboard/graph'; 
import InoutList from '../dashboard/inoutList'; // TimeTable 대신 InoutList를 임포트
